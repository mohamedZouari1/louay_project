...
class Command(BaseCommand):
    ...
    def load_events(self):
        ...
        events = [
            {'title': '12th Edition of UMA Symposium', 'subtitle': 'Nature/Culture', 'description': 'Annual symposium exploring nature and culture.', 'date_display': 'Nov 12-14, 2024', 'image_name': 'symposium', 'order': 1},
            {'title': 'UMA Culture Day 25', 'subtitle': 'Carthage El Hadatha', 'description': 'Celebrating cultural heritage and diversity.', 'date_display': 'Dec 10-11, 2024', 'image_name': 'cultureday', 'order': 2},
            {'title': 'TuniHack 11.0', 'subtitle': 'National Hackathon', 'description': 'The biggest student hackathon in Tunisia held its 11th edition.', 'date_display': 'Nov 22-24, 2024', 'image_name': 'tunihack_11_0', 'order': 3},
            {'title': 'RoboCup ENSI 8', 'subtitle': 'Robotics Competition', 'description': 'The prestigious national robotics challenge.', 'date_display': 'April 28, 2024', 'image_name': 'robocup_ensi_8', 'order': 4},
            {'title': 'Hackathon Green UMA', 'subtitle': 'Sustainable Tech', 'description': 'Focusing on environmental challenges and green solutions.', 'date_display': 'Jan 31 - Feb 1, 2025', 'image_name': 'hackaton_uma', 'order': 5},
            {'title': 'Career Fair 3.0', 'subtitle': 'Professional Networking', 'description': 'Connecting students with top tech companies.', 'date_display': 'April 15, 2025', 'image_name': 'career_fair_3_0', 'order': 6},
            {'title': 'Code Conquer 3.0', 'subtitle': 'Coding Challenge', 'description': 'A high-intensity competitive programming event.', 'date_display': 'May 10, 2025', 'image_name': 'code_conquer_3_0', 'order': 7},
            {'title': 'ESENet Talent Fair 7', 'subtitle': 'Job Fair', 'description': 'The annual talent meeting at ESEN.', 'date_display': 'May 18, 2024', 'image_name': 'esenet_talent_fair_7', 'order': 8},
            {'title': 'GeoDrone Day', 'subtitle': 'Geospatial Innovation', 'description': 'Exploring drones in mapping and geospatial science.', 'date_display': 'June 12, 2024', 'image_name': 'geodrone_day', 'order': 9},
            {'title': 'MSE Hack 1.0', 'subtitle': 'Serious Games Hackathon', 'description': 'Design and build the next generation of educational serious games.', 'date_display': 'June 20, 2024', 'image_name': 'mse_hack_1_0', 'order': 10},
            {'title': 'Orbyx ML Challenge', 'subtitle': 'Machine Learning', 'description': 'Deep dive into AI and ML with real-world datasets.', 'date_display': 'July 15, 2024', 'image_name': 'orbyx_ml_challenge', 'order': 11},
            {'title': 'Green Fortnight', 'subtitle': 'Environmental Awareness', 'description': 'Two weeks of activities dedicated to campus ecology.', 'date_display': 'Oct 1-15, 2024', 'image_name': 'green_fortnight', 'order': 12},
            {'title': 'ESEN Brain Games Expo', 'subtitle': 'Gaming & Strategy', 'description': 'A festival of strategic thinking and digital gaming.', 'date_display': 'Oct 25, 2024', 'image_name': 'esen_brain_games_expo', 'order': 13},
            {'title': 'Recursia 2024', 'subtitle': 'Computing Festival', 'description': 'Celebrating the art of algorithms and recursion.', 'date_display': 'Dec 15, 2024', 'image_name': 'recursia', 'order': 14},
            {'title': 'Manouba Networking Day', 'subtitle': 'Alumni Meeting', 'description': 'Annual networking event connecting students with alumni.', 'date_display': 'April 30, 2024', 'image_name': 'networkingday', 'order': 15},
        ]
        for e in events:
